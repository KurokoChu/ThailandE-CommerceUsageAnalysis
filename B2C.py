"""
Chart : Thailand B2C E-commerce Visitors April - November 2017
"""
import pandas as pd
import pygal as pg
...
xlsx = pd.read_excel(file, sheet_name=0, encoding='UTF-8')
...
chart.title = 'Thailand B2C E-commerce Visitors April - November 2017'
...
# Export chart
chart.render_to_file('chart_B2C.svg')
