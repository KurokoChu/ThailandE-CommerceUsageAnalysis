"""
Chart : Thailand P2P E-commerce Visitors April - November 2017
"""
import pandas as pd
import pygal as pg
...
xlsx = pd.read_excel(file, sheet_name=2, encoding='UTF-8')
...
# Chart title
chart.title = 'Thailand P2P E-commerce Visitors April - November 2017'
...
# Export chart
chart.render_to_file('chart_P2P.svg')
